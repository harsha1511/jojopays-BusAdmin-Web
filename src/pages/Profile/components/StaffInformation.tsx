...
export const StaffInformation = (staffDetails:any) => {


    // console.log(staffDetails.name, "hiii");
  ...
  return (
    ...
    //                 <p className='text-2xl font-semibold ml-6 tracking-[.3rem]'>{staffDetails.name}</p>
    //             </div>
    //         </div>
    ...
    //             <p className='ml-2 w-40 py-1 pl-3 bg-secondary text-sm text-white font-semibold rounded-xl'>{staffDetails.age}</p>
    //             </label>
