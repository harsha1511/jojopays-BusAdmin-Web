...
function AddDriver() {
  return (
    <div className="h-[100%] flex-grid  grid-flow-row w-[100%] p-0">
      ...
      <div className="p-2">
        <div className="bg-contain bg-center bg-no-repeat mt-[30px] p-10 bg-add-driver-cover h-[80%]">
          <div className="p-0 m-0">
            <form className=" mt-20 text-right justify-center text-primaryText grid grid-flow-row gap-4 p-2 text-md">
              <label>
                Name:
                <input
