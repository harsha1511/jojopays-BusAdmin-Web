...
function UpdateDriver() {
  return (
    ...
    <div className="h-[100%] flex-grid  grid-flow-row w-[100%] p-0">
     ...
     <form className="flex mr-60 items-end -mt-4" >
        <div className='w-[730px] text-right justify-start text-base ml-40 text-primaryText font-bold grid grid-flow-row gap-4 pb-2'>
         <label> Name: 
            <input className="ml-3 w-[80%]  p-[3px]  leading-tight  bg-transparent  focus:outline-none focus:line focus:border-border-blue-500  text-white border-none" type="text"name="name"/> {" "}
        </label>
         <label>
         Employee ID: 
           <input type="text" 
        className="ml-3 w-[80%]  p-[3px]  leading-tight  bg-transparent  focus:outline-none focus:line focus:border-border-blue-500  text-white border-none"
        name="Login"
              /> {" "}
        </label>
        <label>
        Jopay ID: <input type="text"
        className="ml-3 w-[80%]  p-[3px]  leading-tight  bg-transparent  focus:outline-none focus:line focus:border-border-blue-500  text-white border-none"
        name="Login"
        /> {" "}
        </label>
        ...
        name="emailid"
        className="ml-3 w-[80%] p-[3px]  appearance-none bg-transparent leading-tight focus:outline-none focus:line focus:border-border-blue-500  text-white border-none"
        /> {" "}
        ...
        {" "}
             ...
             <input type="date" className="Driver-birthday" name="birthday" >
                  ...
                  <div className="line" >
                    ...
                    <p className='bg-green-200 text-#3973FF drop-shadow-lg' >Delete?</p> 
                    </label>
