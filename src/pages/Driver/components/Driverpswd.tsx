        ...
        <div className='flex flex-col items-center w-[1300px] h-[600px] rounded-3xl bg-secondary bg-add-driver-cover bg-cover bg-center bg-no-repeat'>
            ...
            <form className="flex flex-col items-center pt-6 w-[40%] h-[480px] mt-4">
                ...
                <div className="flex flex-col items-center mt-4">
                        ...
                        <p className="w-[220px] h-[28px]  rounded-3xl font-bold flex justify-center items-center bg-quaternary">sugannn</p>
                        ...
                        <p className="mt-2 text-greyText">(Auto Generated ID & Password) 
                        <span className="text-primaryText cursor-pointer">tap to change</span></p>
                        <Link to="/loader">
                            <button
