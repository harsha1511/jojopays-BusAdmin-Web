              ...
              <div className="flex justify-around">
                ...
                <div className="w-80 h-[105px] mt-2 bg-primary rounded-2xl">
                  <div className="pt-2 px-3 mt-1">
                    <div className="flex items-center">
                      ...
                      <input
                        type="date"
                        className="pl-2 bg-tertiary ml-4 p-1 rounded-lg w-[150px] cursor-text focus:border-0 text-white"
                        name=""
                        id=""
                      />
                      <input
                        type="time"
                        className="pl-2 bg-tertiary ml-4 p-1 rounded-lg w-[120px] cursor-text focus:border-0"
                        name=""
                        id=""
                      />
                    </div>
                ...
                <div className="mt-4">
                  <div>
                    ...
                    <input
                      type="text"
                      className="bg-primary p-1 ml-2 w-40 rounded-lg drop-shadow-md focus:border-0 pl-4"
                    />
                  </div>
                  <div className="mt-4">
                    <label
                ...
                <div className="w-72 mt-2 text-primaryText cursor-pointer">
                  <div className="flex justify-around w-68 py-2 bg-primary rounded-2xl">
                    <p className="flex justify-center w-[50%] border-r-2 border-greyText/50">
                      Casual Trip
                    </p>
          ...
          <section className="h-full flex">
            ...
            <div className="flex flex-col items-center w-[25%] h-full bg-secondary">
              ...
              <Link to="/assigned-trip">
                <button className="mt-6 -ml-14 w-56 h-12 bg-quaternary rounded-3xl drop-shadow-lg text-lg text-pinkText font-bold hover:text-white tracking-wide">
                  Assigned Trip
                </button>
              </Link>
            </div>
