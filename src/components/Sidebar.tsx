...
const Sidebar = () => {
  return (
    <nav className="z-10 h-[100vh] hover:h-[100vh] flex-4 w-[72px] group pt-8 hover:w-56 hover:fixed hover:top-0 hover:left-0 hover:z-20 bg-primary transition-all hover:duration-500 shadow-lg shadow-slate-900">
      ...
      <ul className="mt-3">
        {links.map((props) => (
          <li
            className="h-16 flex flex-col items-center group transition-all duration-900 whitespace-nowrap"
            key={props.to}
          >
            <ActiveLink {...props} />
          </li>
